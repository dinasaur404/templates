/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2b0e724fce0fc188629badc3d6a2984d)
// Runtime types generated with workerd@1.20251210.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "NLWebMcp";
	}
	interface Env {
		RAG_ID: "my-autorag-id";
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").NLWebMcp>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RAG_ID">> {}
}
